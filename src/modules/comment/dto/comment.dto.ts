...
export class CommentDto {
  ...
  @ApiProperty({ example: '2025-02-18T12:00:00.000Z', description: 'When the comment was created' })
  createdAt: string;

  @ApiProperty({ example: '2025-02-18T12:00:00.000Z', description: 'When the comment was last updated' })
  updatedAt: string;
}